#!/usr/bin/env python3
"""
Script to extract samples from a SoundFont (.sf2) file and convert each
extracted WAV file into a quantized array (0–15 range) for use with a YM2149F
via an Arduino controller.
"""

# ===============================
# USER CONFIGURATION VARIABLES
# ===============================
SF2_FILE = "E:\\SoundFonts\\chiptune_soundfont_4.0.sf2"         # Path to your SF2 file
OUTPUT_FOLDER = "E:\\SoundFonts\\chiptune_soundfont_4.0"   # Directory to save the extracted WAV files
...
# Use the user-defined SF2 file instead of command-line arguments.
sf2file = SF2_FILE
...
# Use the user-defined output folder instead of computing one from the filename.
folderName = OUTPUT_FOLDER
print("Output folder:", folderName)
